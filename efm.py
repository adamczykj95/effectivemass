...
def fermi_integral(j, eta):
    ...
    integralUpperLimit = 10000  # Set the upper limit of the fermi integrals
...
def theoretical_zt_max(efm_list, kl_list, hall_mobility_list, temperature_list, r_list, cc_low=16, cc_high=21, iterations=100):
    ...
    if check_list_lengths_equal([efm_list, kl_list, hall_mobility_list, temperature_list, r_list]):
        ...
        carrier_concentration_list = np.logspace(cc_low,cc_high,iterations)
